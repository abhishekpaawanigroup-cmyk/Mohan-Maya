  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative max-h-full w-full max-w-md overflow-y-auto rounded-3xl bg-white p-6 shadow-2xl outline-none ring-1 ring-black/5 dark:bg-[#140a0d] dark:ring-white/10 sm:p-8"
      >
